...
public class Projeto {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Com a inovação da Pousada Gatchá, o cliente terá a experiência de descansar em um quarto completamente aleatório, escolhido pelo mais puro RNG.
        //Pagando uma pequena taxa, o cliente poderá sortear novamente o número do seu quarto.
        //A problemática é: O novo garoto do Ti, Joãozinho, queria uma demonstração de uma forma de armazenar os IDs das reservas de uma pousada, então fizemos este código para ele.
        ...
        switch (sc.nextInt()) {
            case 1:
                ...
                System.out.println("Deseja pagar uma taxa para sortear o número do quarto novamente? \n1- Sim\n2- Não");
                System.out.print("\nResposta: ");
